...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CTNetworkingSwift
                   DESC

  s.homepage     = "https://github.com/casatwy/CTNetworkingSwiftDemoSuite"
  ...
  s.source       = { :git => "https://github.com/casatwy/CTNetworkingSwiftDemoSuite.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CTNetworkingSwiftDemoSuite/CTNetworkingSwiftDemoSuite/**/*.{swift}"
  ...
  # s.ios.resource  = "CTNetworkingSwift/CTNetworkingSwift/CTNetworkingSwift.js"
